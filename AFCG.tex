%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%                                                                            %
%    Praca o G - niezmienniczej wersji zbiorow AFC'                          %
%    Historia zmian:                                                         %
%    ---------------                                                         %
% 12.01.2001 Pierwsze poprawki - adres, tytul, etc.Przeformatowanie na       %
%             standard LaTex-a. Zaczatek bibliografii.Ogolniejsza Def.1.     %
%                                                                            %
% 13.01.2001 Dalsze zmiany.Przestawienie twierdzenia o AFC_G->I implikuje    %
%            (Em).Dopisywanie dowodu tegoz twierdzenia.                      %
% 20.01.2001 Poprawki. Poprawki stylistyczne w dow.(Sp).Dopisanie Cor.1      %
%            Dopisanie tw o SFC->(Em). Poprawki w formie def.afcg.           %
% 21.01.2001 Dalsze poprawki i uzupelnienia.                                 %
% 23.01.2001 Przy kompilacji pytanie, czy z komentarzami?                    %
% 30.01.2001 Kolejne poprawki.Tymczasowe wziecie w komentarz partii o        %
%            zbiorach \lambda.Data w naglowkach w trybie z komentarzami.     %
% 31.01.2001 Poczatek dopisywania watku o AFC^*.Poprawki.                    %
% 04.02.2001 Def.SFC i wQN.Poprawki w tw. cof=cov.                           %
% 05.02.2001 Cor.1 przeniesione.Dokonczenie korekt.Uzupelnienie bibliografii.%
% 08.02.2001 Ostateczne drobne poprawki.Pozbycie sie niektorych niejasnosci. %
%            SFC->strongly meager.Wyciete partie o AFC^* - material na       %
%            kolejna publikacje.Zakonczenie przygotowan.                     %
% 11.02.2001 Absolutnie drobne poprawki:Literowki w def.                     %
%                                                                            %
%                                                                            %
%                                                                            %
%                                                                            %
...
\footnotetext[1]{
2000 {Mathematics Subject Classification:} Primary 03E15;
Secondary 03E20, 28E15.
}

\footnotetext[1]{
  Key words: Always first category sets, strongly meager sets,
...
The following definition will be useful for the problems in this chapter.
...
\bibitem[BJ]{BJ} T. Bartoszy\'nski, H. Judah, {\it Set Theory: on the
...
%%%%%%%%%%%%%%%%%%% My address and additional informations %%%%%%%%%%%%%%%%%%%

\begin{center}
\flushleft{{\sl Current address:}} \\
...
\flushleft{{\sl Permanent address:}} \\
...
\begin{center}
%%%Last update of source: February 8, 2001.
\today
\end{center}
